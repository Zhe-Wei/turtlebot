...
def apriltag_callback(data):
    ...
    if data.detections:
        ...
        for detection in data.detections:
            ...
            child_frame_id = "bundle_" + str(tag_id)
...
def broadcast_last_transform():
        ...
        if new_translation:
            ...
            # ts_odom_wrt_map.transform.translation.x = new_translation[0][0]+0.051
            # ts_odom_wrt_map.transform.translation.y = new_translation[1][0]
            # ts_odom_wrt_map.transform.translation.z = new_translation[2][0]+0.01
            ...
            # map2odom.pose.position.x = ts_odom_wrt_map.transform.translation.x
            # map2odom.pose.position.y = ts_odom_wrt_map.transform.translation.y
            # map2odom.pose.position.z = ts_odom_wrt_map.transform.translation.z

            # map2odom.pose.orientation.x = ts_odom_wrt_map.transform.rotation.x
            # map2odom.pose.orientation.y = ts_odom_wrt_map.transform.rotation.y
            # map2odom.pose.orientation.z = ts_odom_wrt_map.transform.rotation.z
            # map2odom.pose.orientation.w = ts_odom_wrt_map.transform.rotation.w
            try:
